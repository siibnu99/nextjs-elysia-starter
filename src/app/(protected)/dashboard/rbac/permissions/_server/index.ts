...
import type { Permission, PermissionBodyInput, PaginatedResponse, PaginationInput } from "./type";

export async function fetchPermissions(params?: PaginationInput): Promise<PaginatedResponse<Permission>> {
...
export async function updatePermission(id: string, input: PermissionBodyInput): Promise<Permission> {
